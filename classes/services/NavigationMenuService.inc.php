...
class NavigationMenuService {
	...
	function getDisplayStatus(&$navigationMenuItem) {
		...
		// Transform an item title if the title matches the name of a template variable
		...
		switch ($menuItemType) {
			...
			case NMI_TYPE_ADMINISTRATION:
				...
				$navigationMenuItem->setIsDisplayed($isUserLoggedIn && array_intersect(array(ROLE_ID_SITE_ADMIN), (array) $userRoles));
				break;
		}
