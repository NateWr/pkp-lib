...
class CategoryDAO extends DAO
{
     ...
     * @return Category?
     */
    public function getById($categoryId, $contextId = null, $parentId = null)
    {
     ...
     * @return Category?
     */
    public function getByPath($path, $contextId)
    {
        $result = $this->retrieve(
     ...
     * @return Category
     */
    public function getByTitle($categoryTitle, $contextId, $locale = null)
    {
     ...
     * @return boolean
     */
    public function categoryExistsByPath($path)
    {
        $result = $this->retrieve(
            'SELECT COUNT(*) AS row_count FROM categories WHERE path = ?',
            [$path]
        );
        $row = $result->current();
     ...
     */
    public function updateLocaleFields($category)
    {
     ...
     */
    public function insertObject($category)
    {
        $this->update(
     ...
     */
    public function resequenceCategories($contextId, $parentCategoryId = null)
    {
        $params = [(int) $contextId];
        if ($parentCategoryId) {
     ...
     * @param $category Category
     */
    public function deleteObject($category)
    {
     ...
     * @param $contextId int optional
     */
    public function deleteById($categoryId, $contextId = null)
    {
        $params = [(int) $categoryId];
        if ($contextId) {
            $params[] = (int) $contextId;
     ...
     * @return DAOResultFactory containing Category ordered by sequence
     */
    public function getByParentId($parentId, $contextId = null, $rangeInfo = null)
    {
        $params = [(int) $parentId];
        if ($contextId) {
            $params[] = (int) $contextId;
