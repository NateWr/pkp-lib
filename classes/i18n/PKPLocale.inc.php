    ...
    */
    ...
    public static function &_getAllLocalesCache()
    {
        ...
        if ($cache === null) {
            ...
            $cache = $cacheManager->getFileCache(
                'locale',
                'list',
                ['AppLocale', '_allLocalesCacheMiss']
            );
    ...
    public static function _allLocalesCacheMiss($cache, $id)
    {
        ...
        if ($allLocales === null) {
            ...
            $notes = & Registry::get('system.debug.notes');
            $notes[] = ['debug.notes.localeListLoad', ['localeList' => LOCALE_REGISTRY_FILE]];
 ...
 * @return string
 */
function __($key, $params = [], $locale = null, $missingKeyHandler = ['PKPLocale', 'addOctothorpes'])
{
