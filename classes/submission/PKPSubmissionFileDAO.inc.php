...
abstract class PKPSubmissionFileDAO extends SchemaDAO implements PKPPubIdPluginDAO
{
     ...
     */
    public function getByPubId($pubIdType, $pubId, $submissionId = null, $contextId = null)
    {
        if (empty($pubId)) {
            return null;
        }
     ...
     * @return SubmissionFile|null
     */
    public function getByBestId($bestId, $submissionId)
    {
        $submissionFile = null;
        if ($bestId != '') {
     ...
     */
    public function assignRevisionToReviewRound($submissionFileId, $reviewRound)
    {
     ...
     */
    public function deleteReviewRoundAssignment($submissionFileId)
    {
